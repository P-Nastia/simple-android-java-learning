...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebTaskApi.Entities.Identity.UserRoleEntity", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<long>", b =>
                {
                    b.HasOne("WebTaskApi.Entities.Identity.RoleEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("WebTaskApi.Entities.Identity.UserEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebTaskApi.Entities.Identity.UserRoleEntity", b =>
                {
                    b.HasOne("WebTaskApi.Entities.Identity.RoleEntity", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
